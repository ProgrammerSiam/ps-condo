  ...
  return (
    <div className="min-h-screen bg-[#fafbfc] flex flex-col">
            ...
            <div className="flex flex-col gap-2">
              {LEFT_ITEMS.map((item) => (
                ...
                >
                  ...
                  <Button
                    type="button"
                    className="bg-[#2563eb] text-white border border-[#2563eb] hover:bg-[#1d4ed8] px-3 py-1 text-sm font-medium flex items-center gap-1"
      ...
      >
        {modal?.label === "Leasing info" ? (
          <form className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="flex items-end justify-end md:col-span-2 mt-2">
              <Button
                type="button"
                className="px-8 bg-[#2563eb] text-white border border-[#2563eb] hover:bg-[#1d4ed8]"
        ...
        ) : modal?.label === "Property address" ? (
          <form className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {/* Property address fields only */}
            <div className="flex flex-col gap-1 md:col-span-2">
              <label className="text-xs font-medium text-gray-700 mb-1">
                Street address<span className="text-[#f43f5e]">*</span>
              </label>
