        ...
        <div className="w-full  p-10 mt-8 mb-8">
              ...
              <div className="p-6 grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="flex flex-col gap-1 md:col-span-1">
                  ...
                  <input
                    ...
                    className="input h-full placeholder:text-[#777980] placeholder:text-[14px] placeholder:font-medium leading-normal"
                  />
                </div>
                <div className="flex flex-col gap-1 md:col-span-1">
                  <label className="text-xs font-medium text-gray-700 mb-1">
          ...
          <div className="flex items-center mb-8">
            <Checkbox
              ...
              className="text-[#272B35] text-[16px] font-semibold leading-normal"
